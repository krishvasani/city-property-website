...
export const posts: BlogPost[] = [
  {
    ...
    body: [
      'Ahmedabad’s western corridor — SG Highway, Prahlad Nagar, Satellite and Bopal — continues to see steady end-user demand, especially for ready-to-move 3 BHK homes. Prices here have held firm rather than spiked, which is good news if you’re a genuine buyer rather than a speculator.',
      'The more interesting movement is along the Ring Road and the emerging Shela–Shantipura belt, where new project supply is coming online. More choice usually means more room to negotiate, particularly on payment schedules and what the developer throws in.',
  ...
  },
  {
    ...
    body: [
      ...
      'Second, get your documents in order: title deed, approved plans, tax receipts and society NOC. Buyers (and their lawyers) move faster when nothing is missing. Third, fix the small stuff and clean thoroughly — presentation genuinely moves price.',
  ...
  },
  {
    ...
    excerpt:
      'Four of Ahmedabad’s most-searched areas, side by side — who each one suits, and roughly what you’ll pay.',
    body: [
      ...
      'Bopal is the family favourite: more space per rupee, good schools, and a calmer pace, in exchange for a longer commute to the centre. Shela, right next door, is where much of the new villa and tower supply is — modern stock at sensible prices.',
