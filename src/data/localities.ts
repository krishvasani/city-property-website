  ...
  return rows.map(([id, name, type, latitude, longitude, extra = {}]) => {
    ...
    return {
      ...
      seoDescription:
        ...
        `Explore ${name} real estate with City Property Services — ${usePhrase} in ${name}, ${city}. Find properties for sale, rent and lease.`,
    };
  });
}
...
export const localities: Locality[] = [
  ...
  ...build('Industrial & Warehousing', [
    ...
    ['kadi', 'Kadi', ['industrial', 'warehousing'], 23.300, 72.330, { priority: 4, city: 'Kadi', district: 'Mehsana', region: 'Mehsana Industrial', popularFor: ['textile & engineering industry'], nearbyAreas: ['chhatral', 'kalol'], description: 'Kadi — an industrial town north of Ahmedabad (Mehsana district). // approximate centroid' }],
  ...
  ...build('GIFT City & Gandhinagar', [
    ...
    ['bhaijipura', 'Bhaijipura', ['residential', 'plots'], 23.200, 72.660, { priority: 4, description: 'Bhaijipura — a village/plotting pocket near Gandhinagar. // approximate centroid', nearbyAreas: ['randesan', 'pethapur'] }],
